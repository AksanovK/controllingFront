import {Mail, User, X} from "react-feather";
      ...
      `}
        >
            <div
                ...
                className={`
                    absolute bg-black rounded-xl p-12 w-2/3 transition-all shadow-2xl max-w-6xl overflow-hidden blur-xl`}>
                <div>
            ...
            <div
                onClick={(e) => e.stopPropagation()}
                className={`
                    relative bg-black rounded-xl p-12 w-2/3 transition-all shadow-2xl max-w-6xl overflow-hidden`}>
                <div>
                    <div className=" ms-auto mb-auto w-auto">
                        <div className="mx-auto ms-auto" style={{ maxWidth: '800px' }}>
                            <h3 className="relative text-start text-5xl font-black text-white mt-3 mb-11">Краткая информация</h3>
